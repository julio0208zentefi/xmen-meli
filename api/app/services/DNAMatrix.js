...
DNAMatrix.checkMatrixSanity = function(dnaMatrix) {
    ...
    let dnaMatrixLength = dnaMatrix.length;
...
DNAMatrix.filterMutantDNASequences = function(dnaSequences) {
    ...
    let filteredSequences = dnaSequences.filter((sequence) => {
...
DNAMatrix.isMutantDNAMatrix = function(dnaMatrix) {
    ...
    let sequences = this.getSequencesFromDNAMatrix(dnaMatrix);
    let mutantSequences = this.filterMutantDNASequences(sequences);
